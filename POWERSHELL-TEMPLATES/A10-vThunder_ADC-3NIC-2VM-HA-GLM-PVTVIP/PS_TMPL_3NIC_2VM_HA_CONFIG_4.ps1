...
# Get PS_TMPL_3NIC_2VM_HA_GLM_PVTVIP_PARAM parameter file content
...
if ($null -eq $ParamData) {
    Write-Error "PS_TMPL_3NIC_2VM_HA_GLM_PVTVIP_PARAM.json file is missing." -ErrorAction Stop
}
...
# Get PS_TMPL_3NIC_2VM_SLB_CONFIG_PARAM slb parameter file content
