...
$absoluteFilePath = -join($PSScriptRoot,"\", "PS_TMPL_3NIC_NVM_VMSS_RUNBOOK_VARIABLES.json")
$resData = Get-Content -Raw -Path $absoluteFilePath | ConvertFrom-Json -AsHashtable
