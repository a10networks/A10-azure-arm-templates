...
# Get parameters
$absoluteFilePath = -join($PSScriptRoot,"\", "PS_TMPL_3NIC_2VM_PUBVIP_PARAM.json")
...
$PublicIPName_vip = $ParamData.parameters.PublicIPName_vip.value
...
# Retrive public IP address for vip
$vipPIp = Get-AzPublicIpAddress -ResourceGroupName $resourceGroupName -Name $PublicIPName_vip
...
$vm2MgmtSubnet = $vnet.Subnets | Where-Object{ $_.Name -eq $subnet1Name }
...
$vm2Data1Subnet = $vnet.Subnets | Where-Object{ $_.Name -eq $subnet2Name }
...
$vm2Data2Subnet = $vnet.Subnets | Where-Object{ $_.Name -eq $subnet3Name }
