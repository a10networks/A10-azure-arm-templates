...
# Get config data
$absoluteFilePath = -join($PSScriptRoot,"\", "CREATE_AUTOMATION_ACCOUNT_PARAM.json")
...
$vnetresourceGroupName = $paramData.vnetresourceGroupName
...
New-AzAutomationVariable -AutomationAccountName $automationAccountName -Name "vnetresourceGroupName" -Encrypted $False -Value $vnetresourceGroupName -ResourceGroupName $resourceGroupName
